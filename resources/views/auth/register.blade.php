...
<head>
  ...
  <style>
    ...
    .animate-fade-up-1 { animation-delay: 0.05s; opacity: 0; }
    .animate-fade-up-2 { animation-delay: 0.1s; opacity: 0; }
    .animate-fade-up-3 { animation-delay: 0.15s; opacity: 0; }
    .animate-fade-up-4 { animation-delay: 0.2s; opacity: 0; }
    .animate-fade-up-5 { animation-delay: 0.25s; opacity: 0; }
    .animate-fade-up-6 { animation-delay: 0.3s; opacity: 0; }
  </style>
</head>
  ...
  <div class="min-h-screen flex flex-col lg:flex-row lg:h-screen lg:overflow-hidden">
    ...
    <div class="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 lg:overflow-auto">
      <div class="w-full max-w-md lg:max-w-lg">
        <a href="{{ url('/') }}" class="inline-flex items-center gap-2 text-slate-600 hover:text-primary-600 transition-colors mb-4 lg:mb-5">
        ...
        <div class="card-form bg-white rounded-2xl p-5 sm:p-6 lg:p-6 animate-fade-up">
          <h1 class="font-gabarito text-xl sm:text-2xl font-bold text-slate-800 mb-0.5 animate-fade-up animate-fade-up-1">Buat akun baru</h1>
          <p class="text-slate-500 text-xs sm:text-sm mb-4 animate-fade-up animate-fade-up-2">Isi data berikut untuk mendaftar PPDB.</p>
          ...
          <form method="POST" action="{{ route('register') }}" class="animate-fade-up animate-fade-up-3">
            ...
            <div class="grid grid-cols-2 gap-3 sm:gap-4 mb-4">
              ...
              <div>
                <label for="password_confirmation" class="block text-xs font-medium text-slate-700 mb-1">Konfirmasi</label>
            ...
            <button type="submit" class="w-full py-3 px-4 btn-primary text-white text-sm font-semibold rounded-xl transition-all duration-200 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
              Daftar Sekarang
            </button>
          </form>
    ...
    <div class="hidden lg:flex lg:w-[48%] panel-right items-center justify-center p-12 relative">
      <div class="relative z-10 text-center max-w-sm">
        ...
        <p class="text-slate-300 text-sm leading-relaxed">Daftar sekali, lengkapi data, dan ikuti proses seleksi PPDB dengan mudah.</p>
      </div>
    </div>
  </div>
