<section id="hero" 
  ...
  <!-- 📝 Teks -->
<div class="flex-1 text-center md:text-left flex flex-col space-y-6 md:pr-4 max-w-lg md:items-start order-2 md:order-1">
  ...
  @if($periodeAktif)
    <div class="bg-blue-50 border border-blue-200 text-blue-700 px-4 py-3 rounded-lg text-sm max-w-md">
      <strong>{{ $periodeAktif->nama_periode }}</strong> – <span class="font-bold">TELAH DIBUKA</span><br>
